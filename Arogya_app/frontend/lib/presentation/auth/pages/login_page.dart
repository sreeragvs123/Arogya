...
import "package:frontend/core/network/api/auth_api.dart";
import "package:frontend/core/configs/firebase_config.dart";
import "package:frontend/data/models/auth_model.dart";
                        ...
                        child:Form(
                          ...
                          child: Column(
                            children:[
                              ...
                              InkWell(
                                onTap:(){
                                  Navigator.push(context, MaterialPageRoute(builder: (context)=>AppModel()));
                                },
                                child:Text(
                                  "Developer Entry",
                                  style:TextStyle(
