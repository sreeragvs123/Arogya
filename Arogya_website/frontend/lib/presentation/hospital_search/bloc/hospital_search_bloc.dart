...
class HospitalSearchBloc extends Bloc<HospitalSearchEvent, HospitalSearchState> {
  final SearchHospitalUsecase searchHospitalUsecase; 

  HospitalSearchBloc(this.searchHospitalUsecase)
    : super(const HospitalSearchState()) {
    on<HospitalQueryChanged>(
      _onQueryChanged,
  ...
  Future<void> _onQueryChanged(
    ...
    result.fold(
      ...
      (hospitals) => emit(
        state.copyWith(isLoading: false, results: hospitals, showResults: true),
      ),
    );
  }
}
