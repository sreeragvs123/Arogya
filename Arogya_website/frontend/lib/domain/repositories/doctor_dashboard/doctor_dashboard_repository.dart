...
abstract class DoctorDashboardRepository {
  ...
  Future<Either<Failure, List<ActivityEntity>>> getRecentActivity({int limit = 10});

  Future<Either<Failure, Unit>> startConsultation({required String consultationId});

  Future<Either<Failure, Unit>> joinConsultationCall({required String consultationId});
}
