...
class DoctorDashboardRepositoryImpl implements DoctorDashboardRepository {
  ...
  @override
  Future<Either<Failure, List<ConsultationEntity>>> getUpcomingConsultations() async {
    try {
  ...
  @override
  Future<Either<Failure, List<ActivityEntity>>> getRecentActivity({int limit = 10}) async {
    try {
  ...
  @override
  Future<Either<Failure, Unit>> startConsultation({required String consultationId}) async {
    try {
  ...
  @override
  Future<Either<Failure, Unit>> joinConsultationCall({required String consultationId}) async {
    try {
      await remoteDataSource.joinConsultationCall(consultationId: consultationId);
      return const Right(unit);
    } on DioException catch (e) {
      return Left(_mapDioError(e));
    } catch (e) {
